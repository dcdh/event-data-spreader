...
import com.damdamdeo.eventdataspreader.event.infrastructure.consumer.KafkaSource;
...
@QuarkusTest
public class AgroalDataSourcePostgreSqlEventConsumedRepositoryTest {
    ...
    public static class TestEventId implements EventId {
    ...
    public static class TestKafkaSource implements KafkaSource {
