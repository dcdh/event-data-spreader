...
@QuarkusTest
public class AggregateRootMaterializedStateRepositoryTest {
    ...
    public void should_persist_new_aggregate_root() throws SQLException {
        ...
        final AggregateRootMaterializedState aggregateRootMaterializedState
                = new AggregateRootMaterializedState("aggregateRootId", "aggregateRootType", 0L, "{}");
    ...
    public void should_update_aggregate_root() throws SQLException {
        // Given
        aggregateRootMaterializedStateRepository.persist(new AggregateRootMaterializedState("aggregateRootId", "aggregateRootType", 0L, "{}"));

        // When
        aggregateRootMaterializedStateRepository.persist(new AggregateRootMaterializedState("aggregateRootId", "aggregateRootType", 1L, "{}"));
