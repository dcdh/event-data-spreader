...
public final class AggregateRootEvent {
    ...
    public AggregateRootEvent(final DecryptableEvent decryptableEvent,
        ...
        this.aggregateRootEventMetaData = decryptableEvent.eventMetaData(encryptedEventSecret, aggregateRootEventMetadataDeSerializer);
    }
    ...
    public String aggregateRootId() {
        return aggregateRootEventId.aggregateRootId().aggregateRootId();
    }

    public String aggregateRootType() {
        return aggregateRootEventId.aggregateRootId().aggregateRootType();
    }
