...
import com.damdamdeo.eventdataspreader.writeside.eventsourcing.api.AggregateRootMaterializedStateRepository;
...
public class PostgreSQLAggregateRootMaterializedStateRepository implements AggregateRootMaterializedStateRepository {
    ...
    private final AgroalDataSource aggregateRootMaterializedStateDataSource;

    public PostgreSQLAggregateRootMaterializedStateRepository(@DataSource("aggregate-root-materialized-state") final AgroalDataSource aggregateRootMaterializedStateDataSource) {
