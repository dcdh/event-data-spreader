...
docker build -f eventsourced-mutable-kafka-connect/Dockerfile -t damdamdeo/eventsourced-mutable-kafka-connect:1.3.0.Final eventsourced-mutable-kafka-connect
