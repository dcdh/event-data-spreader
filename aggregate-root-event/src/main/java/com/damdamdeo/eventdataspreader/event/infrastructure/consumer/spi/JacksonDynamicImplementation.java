...
public final class JacksonDynamicImplementation<T, S> {

    private final Class<? extends T> target;
    private final Class<? extends S> mixinSource;
    private final String name;

    public JacksonDynamicImplementation(final Class<? extends T> target,
    ...
    public boolean equals(Object o) {
        ...
        JacksonDynamicImplementation<?, ?> that = (JacksonDynamicImplementation<?, ?>) o;
